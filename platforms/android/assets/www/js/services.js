.factory('TwitterService', function($cordovaOauth, $cordovaOauthUtility, $http, $resource, $q) {
    ...
    var clientId = 'uIvazjk4d4L36KCjHX2H1BUzs'; //'TwitterAppConsumerKey';
    var clientSecret = 'dOSSM51LSeBZg1XWvSg32ZGsyqmOATZXj3aZPdSWxSHTnFajys'; //'TwitterAppConsumerSecret';
